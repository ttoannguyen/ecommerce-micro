...
| [Milestone 4 implementation plan](implementation-plans/milestone-4-transactional-messaging.md) | Transactional outbox, Kafka publisher và inbox deduplication được kiểm chứng thế nào? |
| [Milestone 5 implementation plan](implementation-plans/milestone-5-resilience-observability.md) | Timeout, retry, resilience và observability được triển khai, kiểm chứng thế nào? |
